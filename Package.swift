...
private let useSwiftParser = true
...
if useSwiftParser {
    dependencies.append(.package(name: "SwiftSyntax", url: "https://github.com/apple/swift-syntax.git", .exact("0.50800.0-SNAPSHOT-2022-12-20-a")))
